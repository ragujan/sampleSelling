...
if (
    ...
    if (isset($_FILES["SampleFile"])) {
        ...
        if (
            ...
            DB::insert("INSERT INTO `samples` (`Sample_Name`,`Sample_Date`,`SamplePrice`,`SubsampleID`,`SampleDescription`)VALUES('" . $sname . "','" . $date . "','" . $sprice . "','" . $subSampletype . "','" . $sampledescription . "') ");
